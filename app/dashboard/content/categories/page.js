...
async function Page() {
  ...
  return (
    <main className="max-w-6xl mx-auto text-white  p-8  h-screen">
      ...
      <section aria-labelledby="category-list-section">
        ...
        <ul className="space-y-4">
          {categories?.map((category) => (
            <li
              key={category._id}
              className="flex justify-between items-center p-4 bg-gray-800 rounded-lg shadow-md space-x-4  "
            >
              {/* Edit Form */}
              <form
              ...
              >
                ...
                <input
                  ...
                  className="text-lg font-semibold text-gray-200 bg-transparent border border-gray-600 rounded-lg p-2 "
                  defaultValue={category.name}
                  name="name"
                />
                <input
                  id={`category-${category._id}`}
                  className="text-lg font-semibold text-gray-200 bg-transparent border border-gray-600 rounded-lg p-2 flex-1"
